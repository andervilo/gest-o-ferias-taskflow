-- TaskFlow — dados demo para avaliação.
-- Senha de TODOS os usuários abaixo: "password"
-- Hash BCrypt: $2a$10$ZZun4DPv1GZ7q5us0QM7g.3uXajxCEMSLyPHOW1Uj0qXtjXEYKNMa
...
-- Collaborators (cada um associado a um manager)
INSERT INTO employees (id, name, email, password_hash, role, manager_id) VALUES
